...
* 更改工作区间主题
  ...
  {% asset_img ede1d136-3e29-11e7-a919-92ebcb67fe33.png %}
...
* F4 查找变量来源
* Ctrl + N 查找指定类
  {% asset_img f797c144-3fba-11e7-a919-92ebcb67fe33.png %}

* Ctrl + Shift + N 全局搜索文件
  {% asset_img 8715f962-3fbb-11e7-a919-92ebcb67fe33.png %}

* Ctrl + Shift + Alt + N 查找php类名/变量名/js方法名和变量名/css选择器
  {% asset_img 9f3564fa-3fbc-11e7-a919-92ebcb67fe33.png %}

* Ctrl + B  定位变量来源（同Ctrl + 单击）
  {% asset_img 7568394e-3fbd-11e7-a919-92ebcb67fe33.png %}

* Ctrl + Alt + B  找到父级的所有子类
  {% asset_img f4123ede-3fbd-11e7-a919-92ebcb67fe33.png %}

* Ctrl + G 定位行
  {% asset_img 3cea2b6c-3fbe-11e7-a919-92ebcb67fe33.png %}

* Ctrl + F 在当前窗口查找文本
  {% asset_img 9b5aecc2-3fbe-11e7-a919-92ebcb67fe33.png %}

* Ctrl + Shift + F 在指定路径查找
  {% asset_img f76994dc-3fbe-11e7-a919-92ebcb67fe33.png %}

* Ctrl + R 当前窗口替换文本
  {% asset_img 688eeafe-3fbf-11e7-a919-92ebcb67fe33.png %}

* Ctrl + Shift + R 在指定路径替换文本
  {% asset_img b1c4c23e-3fbf-11e7-a919-92ebcb67fe33.png %}

* Ctrl + E 查看最近打开的文件
  {% asset_img 0b66bdb0-3fc0-11e7-a919-92ebcb67fe33.png %}

### 自动代码

* Ctrl + J 自动代码提示和补全
  {% asset_img abfc1072-3fc0-11e7-a919-92ebcb67fe33.png %}

* Ctrl + Alt + L 格式化代码
  {% asset_img 110f81f6-3fc1-11e7-a919-92ebcb67fe33.png %}

* Ctrl + Alt + I 自动缩进
* Ctrl + P 方法参数提示
  {% asset_img 96be6d1c-3fc1-11e7-a919-92ebcb67fe33.png %}

* Ctrl + Insert 生产类的get|set方法|构造函数等
  {% asset_img 46058594-3fc2-11e7-a919-92ebcb67fe33.png %}
* Ctrl + H 显示类层级关系图
  {% asset_img fae803a0-3fc3-11e7-a919-92ebcb67fe33.png %}

* Ctrl + F12 显示文件结构
  {% asset_img 29b45a8a-3fc4-11e7-a919-92ebcb67fe33.png %}

* Ctrl + W 块状态选中代码
  {% asset_img 9b4ffbae-3fc4-11e7-a919-92ebcb67fe33.png %}

* Ctrl + O 类的魔术方法
  {% asset_img d02a9352-3fc4-11e7-a919-92ebcb67fe33.png %}

* Ctrl + Shift + I 快速定义变量和方法
  {% asset_img 378ef9e8-3fc5-11e7-a919-92ebcb67fe33.png %}

* Ctrl + [] 光标移动到{}开头或结尾
  {% asset_img 06eca43d-481b-4762-a0af-7742482c0696.png %}

* Ctrl + Shift + [] 选中光标至[]之间的代码块
  {% asset_img 9af0376f-991f-485d-985e-42e7456d11e3.png %}

* Ctrl + / 单行注释/取消注释
* Ctrl + Shift + / 块注释/取消块注释
* Shift + ⬆/⬇/➡/⬅ 进行区域性选中代码
  {% asset_img 88d5ee69-fae4-406c-aed7-ddd0a7ff2108.png %}
...
* Ctrl + Shift + Enter 智能补全代码
  {% asset_img 40abd94d-e333-40cf-bd4b-30a27ad8484a.png %}

* Ctrl + Shift + ⬆/⬇ 选中区域进行上下移动
* Shift + F6 重命名文件名/类名/函数名/变量名
  {% asset_img a2d96914-f897-4ab0-89b2-26c4f805e282.png %}
...
{% asset_img 6cee9eb9-c0a8-4273-926e-8775fe8d15e8.png %}

连接成功后，所有操作同 Xshell，如下图所示：
{% asset_img bb2a5138-34c7-4026-b7e4-44679dc5d5cd.png %}
...
{% asset_img 64e32996-f122-46fe-bf79-0a736e0d2a53.png %}

填写 Host、Port、User、Password 这些基本连接信息，可点击”Test Connection“测试配置是否正确，然后点击”OK“。当然还可以使用 SSH 隧道加密连接。

{% asset_img b1599018-5b7f-46d8-b97c-e129e0ea631e.png %}

双击查看维基站的 wiki_archive 表，如下：

{% asset_img edb7eb37-1565-4a0c-a4e6-f3629246fb09.png %}

在数据表列表选中 wiki_archive 右键，即可对表进行操作：

{% asset_img e4daad6b-c360-4581-a974-c84292e4fe92.png %}

执行 SQL，需要在 Database 面板上点击”QL“图标（或者 Ctrl + Alt + F10），输入需要执行的 SQL 并敲 Ctrl + Enter，如下：

{% asset_img c61f19e2-9067-4d83-b71a-8a6097113968.png %}
...
{% asset_img cf18c3c6-893b-480b-8f23-9e307795aea0.png %}

需要向本地库添加新文件时，点击“Git >> Add“即可。

Commit 修改时，选中项目目录点击“Git >> Commit Directory”，如下：

{% asset_img 671a31a8-d6ab-4360-85be-e91b558aa42f.png %}

创建分支时，点击“Git >> Repository >> Branches”，如下：

{% asset_img c70747a5-72b1-4e86-b403-6de95a7ad7c3.png %}

Pull 和 Push 代码时，直接点击“Git >> Repository >> Pull/Push“。

查看某个文件的提交记录，只需选中文件并右击 “Git >> Show History”，如下：

{% asset_img 18b8699d-36c8-481e-ac72-3fe842c895fb.png %}

在 PhpStorm 底部栏“Version Control”中，可查看到 Git 相关的日志信息。

{% asset_img 93de4c13-d30b-4d36-a017-44cb7e5078a5.png %}
...
![](https://www.fanhaobai.com/2017/05/phpstorm-posture/0e835fc8-3fd6-4531-8480-44cd33a83655.png)
